...
@class NSTimer, PasswordRemainderCorpViewController, PasswordRemainderViewController, UIButton, UIImageView, UILabel, UITableView, UIViewController;

@interface PasswordRemainderMenuViewController : _ABAddressBookCopyArrayOfAllPeople <UITableViewDataSource, UITableViewDelegate>
{
    ...
    NSTimer *mytimer;
    PasswordRemainderViewController *PasswordRemainderView;
    PasswordRemainderCorpViewController *PasswordRemainderCorpView;
}

- (void)setPasswordRemainderCorpView:(id)fp8;
- (id)PasswordRemainderCorpView;
- (void)setPasswordRemainderView:(id)fp8;
- (id)PasswordRemainderView;
