...
@class NSTimer, PlansViewController, PopupViewController, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UITableView, UIViewController;

@interface PlanCategoriesViewController : _ABAddressBookCopyArrayOfAllPeople <UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate>
{
    ...
    UILabel *loading;
    PlansViewController *PlansView;
    PopupViewController *PopupView;
}

- (void)setPopupView:(id)fp8;
- (id)PopupView;
- (void)setPlansView:(id)fp8;
- (id)PlansView;
