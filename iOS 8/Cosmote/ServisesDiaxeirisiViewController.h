...
@class NSMutableArray, NSTimer, TermsViewController, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIScrollView, UIView, UIViewController;

@interface ServisesDiaxeirisiViewController : _ABAddressBookCopyArrayOfAllPeople <UIAlertViewDelegate>
{
...
- (void)radioButtonInvisibleClicked:(id)fp8;
