...
@class MapNoGPSPageViewController, NSTimer, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIViewController;

@interface MapsDetailsViewController : _ABAddressBookCopyArrayOfAllPeople
{
    ...
    UILabel *loading;
    MapNoGPSPageViewController *MapNoGPSPageView;
}

- (void)setMapNoGPSPageView:(id)fp8;
- (id)MapNoGPSPageView;
...
- (id)headerImage;
- (void)setBut_klhsh:(id)fp8;
- (id)but_klhsh;
- (void)setBut_euresh:(id)fp8;
- (id)but_euresh;
- (void)setLb3:(id)fp8;
- (id)lb3;
- (void)setLb2:(id)fp8;
...
- (void)goBack:(id)fp8;
- (void)calltostore:(id)fp8;
- (void)findinmap:(id)fp8;
- (void)makeHTTPConn;
- (void)GoToRoot;
- (void)buildHeader;
