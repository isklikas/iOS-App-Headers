...
@class NSTimer, UIButton, UIImageView, UILabel, UIViewController;

@interface ServisesThankyouViewController : _ABAddressBookCopyArrayOfAllPeople
{
...
- (BOOL)notif_egain_open;
- (void)setSeeyourrequest_btn:(id)fp8;
- (id)seeyourrequest_btn;
- (void)setLb2:(id)fp8;
- (id)lb2;
- (void)setLb1:(id)fp8;
- (id)lb1;
