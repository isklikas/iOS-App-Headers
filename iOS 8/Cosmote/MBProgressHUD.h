...
@interface MBProgressHUD : _ABAddressBookCopyArrayOfAllPeople
{
    BOOL useAnimation;
...
- (id)completionBlock;
- (void)setActivityIndicatorColor:(id)fp8;
...
- (id)indicator;
- (void)setDetailsLabelColor:(id)fp8;
...
- (void)statusBarOrientationDidChange:(id)fp8;
