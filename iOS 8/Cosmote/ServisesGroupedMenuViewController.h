...
@class NSTimer, ServisesGroupedViewController, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UITableView, UIViewController;

@interface ServisesGroupedMenuViewController : _ABAddressBookCopyArrayOfAllPeople <UITableViewDataSource, UITableViewDelegate>
{
