...
@class NSTimer, TermsViewController, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIScrollView, UITextField, UIView, UIViewController;

@interface SimCardChangeViewController : _ABAddressBookCopyArrayOfAllPeople <UIAlertViewDelegate>
{
