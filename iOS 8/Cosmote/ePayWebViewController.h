...
@class NSString, NSTimer, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIViewController, UIWebView;

@interface ePayWebViewController : _ABAddressBookCopyArrayOfAllPeople
{
