...
@class AllesXrewseisViewController, MyBillDetailsViewController, NSTimer, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UITableView, UIViewController;

@interface SinoptikiAnalisiViewController : _ABAddressBookCopyArrayOfAllPeople <UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate>
{
    ...
    AllesXrewseisViewController *AllesXrewseisView;
}

- (void)setAllesXrewseisView:(id)fp8;
- (id)AllesXrewseisView;
...
- (BOOL)notif_egain_open;
- (void)setAnalisiLogariasmou:(id)fp8;
- (id)analisiLogariasmou;
...
- (void)viewDidUnload;
- (void)allesXrewseis_act:(id)fp8;
- (void)analisiLogariasmou_act:(id)fp8;
- (void)goBack:(id)fp8;
- (void)chargeout:(id)fp8;
- (void)chargein:(id)fp8;
