...
@interface FindMsisdnAndVPNViewController : _ABAddressBookCopyArrayOfAllPeople
{
...
- (void)setBut1:(id)fp8;
- (id)but1;
- (void)setTextField2:(id)fp8;
- (id)textField2;
- (void)setTextField1:(id)fp8;
- (id)textField1;
...
- (void)submit_act2:(id)fp8;
- (void)submit_act1:(id)fp8;
- (void)goBack:(id)fp8;
- (void)buildHeader;
- (void)makeHTTPConn;
- (void)GoToRoot;
