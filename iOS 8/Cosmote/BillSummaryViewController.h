...
@class NSMutableArray, NSString, NSTimer, SinoptikiAnalisiViewController, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UITableView, UIViewController;

@interface BillSummaryViewController : _ABAddressBookCopyArrayOfAllPeople <UITableViewDataSource, UITableViewDelegate>
{
    ...
    UIButton *sinoptanalButton;
    UIButton *plirwmhLogariasmouButton;
    NSString *applAccess;
    NSString *applAccessMessage;
...
- (BOOL)notif_egain_open;
- (void)setApplAccessMessage:(id)fp8;
- (id)applAccessMessage;
- (void)setApplAccess:(id)fp8;
- (id)applAccess;
- (void)setPlirwmhLogariasmouButton:(id)fp8;
- (id)plirwmhLogariasmouButton;
- (void)setSinoptanalButton:(id)fp8;
- (id)sinoptanalButton;
...
- (void)plirwmhLogariasmouButton_act:(id)fp8;
- (void)sinoptanal:(id)fp8;
