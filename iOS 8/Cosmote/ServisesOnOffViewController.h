...
@class NSTimer, TermsViewController, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIScrollView, UIView, UIViewController;

@interface ServisesOnOffViewController : _ABAddressBookCopyArrayOfAllPeople <UIAlertViewDelegate>
{
    BOOL isActive;
