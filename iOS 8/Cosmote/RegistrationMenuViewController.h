...
@class NSTimer, RegistrationViewController, UIButton, UIImageView, UILabel, UITableView, UIViewController;

@interface RegistrationMenuViewController : _ABAddressBookCopyArrayOfAllPeople <UITableViewDataSource, UITableViewDelegate>
{
...
- (void)setRegistrationView:(id)fp8;
- (id)RegistrationView;
