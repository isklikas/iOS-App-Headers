...
@property (nonatomic,retain) NSString* messageId; 				//@synthesize _messageId=__messageId - In the implementation block
...
@property (assign,nonatomic) long long blockCount; 				//@synthesize _blockCount=__blockCount - In the implementation block
...
-(void)setBlockCount:(long long)arg1;
