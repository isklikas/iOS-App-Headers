...
@interface FriendsPlaylistsReply : PBGeneratedMessage {
	PBAppendableArray* playlistsArray; 
}
@property (@dynamic,copy) PBArray* playlists; 
@property (retain) PBAppendableArray* playlistsArray; 
+(id)builder;
...
-(id)toBuilder;
-(void)setPlaylistsArray:(id)arg1;
