...
@interface PeopleChooserVC : SPViewController <UISearchDisplayDelegate, UISearchBarDelegate, FBDialogDelegate, SPSocialLookupDelegate, SPTHTTPImageLoaderDelegate, SPTableViewDelegate, UITableViewDataSource, SPTNavigationControllerNavigationBarState> {
